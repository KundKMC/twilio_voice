...
public class SwiftTwilioVoicePlugin: NSObject, FlutterPlugin,  FlutterStreamHandler, PKPushRegistryDelegate, NotificationDelegate, CallDelegate, AVAudioPlayerDelegate, CXProviderDelegate {
    ...
    public override init() {
        ...
        if let unwrappedRegistrar = registrar {
            let eventChannel = FlutterEventChannel(name: "twilio_voice_mimp/events", binaryMessenger: unwrappedRegistrar.messenger())
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let methodChannel = FlutterMethodChannel(name: "twilio_voice_mimp/messages", binaryMessenger: registrar.messenger())
        let eventChannel = FlutterEventChannel(name: "twilio_voice_mimp/events", binaryMessenger: registrar.messenger())
